...
personajes = [
    {"name": "Señor Amapola", "image": "imagesClue/amapola.png"},
    {"name": "Profesora Mora", "image": "imagesClue/mora.jpg"},
    {"name": "Señora Blanco", "image": "imagesClue/blanco.jpg"},
    {"name": "Coronel Mostaza", "image": "imagesClue/mostaza.jpg"},
    {"name": "Doctor Verde", "image": "imagesClue/verde.jpg"},
    {"name": "Señorita Celeste", "image": "imagesClue/celeste.jpg"}
]

armas = [
    {"name": "Candelabro", "image": "imagesClue/candelabro.png"},
    {"name": "Cuchillo", "image": "imagesClue/cuchillo.jpg"},
    {"name": "Cuerda", "image": "imagesClue/cuerda.jpg"},
    {"name": "Llave Inglesa", "image": "imagesClue/llave_inglesa.jpg"},
    {"name": "Revolver", "image": "imagesClue/revolver.jpg"},
    {"name": "Tubo", "image": "imagesClue/tubo.jpg"}
]

habitaciones = [
    {"name": "Cocina", "image": "imagesClue/cocina.png"},
    {"name": "Comedor", "image": "imagesClue/comedor.jpg"},
    {"name": "Sala de Baile", "image": "imagesClue/sala_baile.jpg"},
    {"name": "Invernadero", "image": "imagesClue/invernadero.jpg"},
    {"name": "Biblioteca", "image": "imagesClue/biblioteca.jpg"},
    {"name": "Estudio", "image": "imagesClue/estudio.jpg"},
    {"name": "Sala", "image": "imagesClue/sala.jpg"},
    {"name": "Vestíbulo", "image": "imagesClue/vestibulo.jpg"},
    {"name": "Billar", "image": "imagesClue/billar.jpg"}
]
...
def mostrar_ventana(titulo, mensaje):
    ...
    # Agregar la imagen
    if titulo == "¡Ganaste!":
        imagen_path = "imagesClue/ganaste.gif"
    elif titulo == "¡Ganó IA!":
        imagen_path = "imagesClue/ia_gano.jpg"
    else:
        imagen_path = "imagesClue/perdiste.gif"
